/**
 * Created by Kokanm on 12/11/2014.
 */
// Fig. 12.5: dom.js
...
function start()
{
    ...
    document.getElementById( "insertButton" ).addEventListener(
        "click", insert, false );
    document.getElementById( "newS" ).addEventListener(
        "click", appendNode, false );
    document.getElementById( "replaceS" ).addEventListener(
        "click", replaceCurrent, false );
    document.getElementById( "removeS" ).addEventListener(
        "click", remove, false );
    document.getElementById( "parentButton" ).addEventListener(
        "click", parent, false );

    // initialize currentNode
    currentNode = document.getElementById( "para1" );
} // end function start
...
{
    var newNode = createNewNode(
        document.getElementById( "replaceT" ).value );
